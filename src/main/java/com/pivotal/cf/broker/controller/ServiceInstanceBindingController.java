...
public class ServiceInstanceBindingController extends BaseController {
	...
	public ResponseEntity<ServiceInstanceBindingResponse> bindServiceInstance(
		...
		logger.info( "PUT: " + BASE_PATH + "/{bindingId}"
				...
				+ ", bindingId = " + bindingId);
		ServiceInstance instance = instanceService.getServiceInstance(instanceId);
	...
	public ResponseEntity<String> deleteServiceInstanceBinding(
		...
		logger.info( "DELETE: " + BASE_PATH + "/{bindingId}"
				...
				+ ", serviceId = " + serviceId
				+ ", planId = " + planId);
		ServiceInstanceBinding binding = instanceBindingService.deleteServiceInstanceBinding(bindingId);
		if (binding == null) {
			return new ResponseEntity<String>("{}", HttpStatus.NOT_FOUND);
		}
		logger.info("ServiceInstanceBinding Deleted: " + binding.getId());
