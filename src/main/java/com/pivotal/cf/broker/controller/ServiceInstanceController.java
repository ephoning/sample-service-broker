...
public class ServiceInstanceController extends BaseController {
	...
	public @ResponseBody List<ServiceInstance> getServiceInstances() {
		logger.info("GET: " + BASE_PATH + ", getServiceInstances()");
		return instanceService.getAllServiceInstances();
	}
	...
	public ResponseEntity<CreateServiceInstanceResponse> createServiceInstance(
		...
		logger.info("PUT: " + BASE_PATH + "/{instanceId}" + ", createServiceInstance(), serviceInstanceId = " + serviceInstanceId);
	...
	public ResponseEntity<String> deleteServiceInstance(
		...
		logger.info("DELETE: " + BASE_PATH + "/{instanceId}"
               + ", deleteServiceInstanceBinding(), serviceInstanceId = " + instanceId
                + ", serviceId = " + serviceId
                + ", planId = " + planId);
		ServiceInstance instance = instanceService.deleteServiceInstance(instanceId);
		if (instance == null) {
			return new ResponseEntity<String>("{}", HttpStatus.GONE);
		}
		logger.info("ServiceInstance Deleted: " + instance.getId());
