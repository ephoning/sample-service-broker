...
public class OracleServiceInstanceBindingService implements ServiceInstanceBindingService {
    ...
    public ServiceInstanceBinding createServiceInstanceBinding(
        ...
        try {
            ...
            String passwordHash = oracleJdbcTemplate.queryForObject(getPasswordHashSQL, String.class);
            ...
            String createGrantAndUserSQL = String.format(createGrantAndUserSQLTemplate,
                    ...
                    passwordHash,
                    withClauses);
            oracleJdbcTemplate.update(createGrantAndUserSQL);
        }
        catch(Exception e) {
    ...
    public ServiceInstanceBinding deleteServiceInstanceBinding(String id)
        ...
        try {
            oracleJdbcTemplate.update(deleteGrantAndUserSQL);
        }
        catch(Exception e) {
            throw new ServiceBrokerException(e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
