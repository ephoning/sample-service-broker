...
/**
 * A simple service instance service that creates and deletes MySQL databases/schemas
 *
...
public class MySQLServiceInstanceService implements ServiceInstanceService {
    ...
    public ServiceInstance createServiceInstance(
        ...
        try {
            ...
            jdbcTemplate.update(createSchemaSQL);
        }
        catch (Exception e) {
    ...
    public ServiceInstance deleteServiceInstance(String id)
        ...
        try {
            ...
            jdbcTemplate.update(deleteSchemaSQL);
        }
        catch(Exception e) {
            throw new ServiceBrokerException(e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
